...
def view_customer_view(request):
    ...
    # Render the page with the paginated customers
    return render(request, 'ecom/view_customer.html', {'page_obj': page_obj})
...
def my_profile_view(request):
    ...
    if not customer.profile_pic:
        customer.profile_pic = 'profile_pic/image.png'  # Use relative path for default image
        customer.save()  # Don't forget to save the customer object if you set the profile_pic
